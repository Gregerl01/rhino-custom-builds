...
// If the secondary CTA is a phone fallback ("tel:" with an empty number),
// fill it in from bmg_phone so the service pages stay in sync with the
// Customizer without the content array having to duplicate the number.
if ( ! empty( $cta_secondary['url'] ) && $cta_secondary['url'] === 'tel:' ) {
