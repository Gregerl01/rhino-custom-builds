			...
			array(
				...
				'products'      => array(
					array(
						...
						'price'         => '$2,145.95+',
						'vehicle_types' => array( 'truck', 'jeep', 'suv' ),
						'image'         => 'https://cdn11.bigcommerce.com/s-wg9nennc1z/images/stencil/2000x2000/products/12521/13140962/arb-full-deluxe-modular-bumper-kit-2236010__09761.1751788886.jpg?c=1',
					...
					array(
						...
						'image'         => 'https://www.procompusa.com//wp-content/uploads/product-images/smittybilt/76807-01.jpg',
					...
					array(
						...
						'image'         => 'https://media.roughcountry.com/media/catalog/product/1/r/1rc_1106.jpg',
			...
			array(
				...
				'products'      => array(
					array(
						...
						'image'         => 'https://cdn11.bigcommerce.com/s-xabjiyiwa/product_images/attribute_rule_images/71192_source_1721213821.jpg',
					...
					array(
						...
						'price'         => 'quote',
						'vehicle_types' => array( 'truck', 'jeep', 'suv', 'van', 'universal' ),
						'image'         => 'https://cdn11.bigcommerce.com/s-xabjiyiwa/product_images/attribute_rule_images/65019_source_1721213701.jpg',
					...
					array(
						...
						'price'         => '$279.99+',
						'vehicle_types' => array( 'truck', 'jeep', 'suv', 'van', 'universal' ),
						'image'         => 'https://www.rigidindustries.com/media/catalog/product/cache/b593058e121c054ba36b8a51be9db714/2/0/202113_d-series_pro_flood_sm_2.jpg',
			...
			array(
				...
				'products'      => array(
					array(
						...
						'price'         => 'quote',
						'vehicle_types' => array( 'truck', 'jeep', 'suv' ),
						'image'         => 'https://ridefox.com/cdn/shop/files/985_62_012_fox_truck_performance_coil_over_shock_op_1600x1600_82213013-5137-43bf-a4c7-daff6fbc9fdf.png?v=1775673267&width=960',
					...
					array(
						...
						'price'         => 'quote',
						'vehicle_types' => array( 'truck', 'jeep', 'suv' ),
						'image'         => 'https://ridefox.com/cdn/shop/files/883_06_157_fox_truck_performance_elite_coil_over_shock_pr_1600x1600_30cde821-3391-4a9d-b83a-f16d86f3c7ed.png?v=1773813929&width=960',
					...
					array(
						...
						'price'         => '$1,399.95+',
						'vehicle_types' => array( 'truck' ),
						'image'         => 'https://media.roughcountry.com/media/catalog/product/2/0/2021_f150_6in_n3_lift_-_49930.jpg',
			...
			array(
				...
				'products'      => array(
					array(
						...
						'price'         => '$335.00+',
						'vehicle_types' => array( 'truck', 'jeep', 'suv' ),
						'image'         => 'https://www.methodracewheels.com/cdn/shop/products/MR305_NV_wheel-6lug-titanium-17x8-5-1000_1000x1000.jpg?v=1746418269',
					...
					array(
						...
						'price'         => '$366.00+',
						'vehicle_types' => array( 'truck', 'jeep', 'suv' ),
						'image'         => 'https://www.methodracewheels.com/cdn/shop/products/method-mr703-pro-master-5lug-matte-black-16x6-1000_1000x1000.jpg?v=1746417663',
					...
					array(
						...
						'image'         => 'https://dxm.contentcenter.michelin.com/api/wedia/dam/transform/b98rpyxf61b4x7ma7misnkcmry/4w-996_3528702987483_tire_bfgoodrich_all-terrain-t-slash-a-ko3_lt-265-slash-70-r17-123-slash-120s_rwl_a_main_1-30_nopad.webp?t=resize&height=500',
					...
					array(
						...
						'price'         => 'quote',
						'vehicle_types' => array( 'truck', 'suv', 'jeep' ),
						'image'         => 'https://dxm.contentcenter.michelin.com/api/wedia/dam/transform/b98rpyxf61b4xf8sbi86qxnr7o/4w-354_3528700726046_tire_bfgoodrich_mud-terrain-t-slash-a-km3_lt-265-slash-70-r17-121-slash-118q-lre_rbl_a_main_1-30_nopad.webp?t=resize&height=500',
			...
			array(
				...
				'products'      => array(
					array(
						...
						'price'         => '$1,836.23',
						'vehicle_types' => array( 'truck', 'jeep', 'suv', 'universal' ),
						'image'         => 'https://marvel-b1-cdn.bc0a.com/f00000000190858/www.warn.com/images/thumbs/0008818_zeon-xd-10-s-110010_625.jpeg',
					...
					array(
						...
						'price'         => 'quote',
						'vehicle_types' => array( 'truck', 'jeep', 'suv', 'universal' ),
						'image'         => 'https://www.procompusa.com//wp-content/uploads/product-images/smittybilt/98812-01.jpg',
					...
					array(
						...
						'image'         => 'https://cdn11.bigcommerce.com/s-wg9nennc1z/images/stencil/960w/products/12662/13145183/arb-weekender-recovery-kit-rk12a__99108.1751795618.jpg?c=1',
					...
					array(
						...
						'price'         => '$499.95',
						'vehicle_types' => array( 'universal' ),
						'image'         => 'https://cdn11.bigcommerce.com/s-wg9nennc1z/images/stencil/960w/products/12663/13141088/arb-premium-recovery-kit-rk9a__68275.1751789103.jpg?c=1',
						'source_url'    => 'https://store.arbusa.com/recovery/off-road-recovery-kits/',
					),
				),
			),
			...
			array(
				...
				'products'      => array(
					array(
						...
						'price'         => '$219.95',
						'vehicle_types' => array( 'truck' ),
						'image'         => 'https://media.roughcountry.com/media/catalog/product/1/4/14-18-gm-tri-fold23.jpg',
					...
					array(
						...
						'price'         => '$849.95',
						'vehicle_types' => array( 'truck' ),
						'image'         => 'https://media.roughcountry.com/media/catalog/product/a/g/ag4a9329_1.jpg',
					...
					array(
						...
						'price'         => '$960.00',
						'vehicle_types' => array( 'truck', 'jeep', 'suv' ),
						'image'         => 'https://cdn11.bigcommerce.com/s-wg9nennc1z/images/stencil/1920w/t/drawers__76378.original.jpg',
			...
			array(
				...
				'products'      => array(
					array(
						...
						'image'         => 'https://assets.rhinorack.com/Images/Platforms/62109/62109-00.jpg',
					...
					array(
						...
						'price'         => 'quote',
						'vehicle_types' => array( 'truck' ),
						'image'         => 'https://assets.rhinorack.com/Images/Parts/Truck-Bed/Bars/Reconn-Deck-Bars-06.jpg',
					...
					array(
						...
						'price'         => '$1,299.99',
						'vehicle_types' => array( 'universal' ),
						'image'         => 'https://assets.rhinorack.com/Images/PageImages/Landing/Awnings/32145-LH-Batwing-270-00-op.jpg',
			...
			array(
				...
				'products'      => array(
					array(
						...
						'image'         => 'https://media.roughcountry.com/media/catalog/product/1/9/19-20_chevy_silverado_seat_cover_-_91035.jpg',
					...
					array(
						...
						'price'         => '$69.95',
						'vehicle_types' => array( 'truck', 'suv' ),
						'image'         => 'https://media.roughcountry.com/media/catalog/product/1/4/14-18_gm_1500_flex-fit_floor_mats_-_ff-21413.jpg',
					...
					array(
						...
						'price'         => '$219.95',
						'vehicle_types' => array( 'truck', 'jeep', 'suv', 'universal' ),
						'image'         => 'https://media.roughcountry.com/media/catalog/product/8/-/8-gang-multiple-light-controller_70970a-install8.jpg',
					...
					array(
						...
						'image'         => 'https://www.procompusa.com//wp-content/uploads/product-images/smittybilt/769315-01.jpg',
			...
			array(
				...
				'products'      => array(
					array(
						...
						'price'         => '$449.95',
						'vehicle_types' => array( 'truck' ),
						'image'         => 'https://media.roughcountry.com/media/catalog/product/f/c/fc3a1502.jpg',
					...
					array(
						...
						'price'         => '$449.95',
						'vehicle_types' => array( 'truck' ),
						'image'         => 'https://media.roughcountry.com/media/catalog/product/c/h/chevy-ov2-install.jpg',
					...
					array(
						...
						'price'         => '$379.95',
						'vehicle_types' => array( 'truck', 'suv' ),
						'image'         => 'https://media.roughcountry.com/media/catalog/product/1/s/1swgvt8p.jpeg',
					...
					array(
						...
						'price'         => '$229.99+',
						'vehicle_types' => array( 'jeep' ),
						'image'         => 'https://static.summitracing.com/global/images/prod/xlarge/smt-77852_xl.jpg',
